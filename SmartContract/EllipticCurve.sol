...
struct AnnualRegister {
    uint[2] rs;
    uint8 year;
}

mapping (string => AnnualRegister) emissionRegister;
    ...
    function validateAndRecordMessage(bytes32 data, bytes32 hash, uint[2] memory rs, uint[2] memory Q) public pure
        returns (bool)
    {
